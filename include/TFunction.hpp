#ifndef LABWORK10_YURYS0_TFUNCTION_HPP
#define LABWORK10_YURYS0_TFUNCTION_HPP
...
namespace my_std {
    ...
    public:
        ...
        template<typename Func>
        explicit function(const Func& x) : f(new concrete_function<typename func_filter<Func>::type, Result, Args...>(x)) {}

        function(const function& rhs) : f(rhs.f ? rhs.f->clone() : nullptr) {}

        function& operator=(const function& rhs) {
            if ((&rhs != this) && rhs._f) {
                auto* temp = rhs._f->clone();
                delete f;
                f = temp;
            }
            return *this;
...
#endif //LABWORK10_YURYS0_TFUNCTION_HPP
